...
from .views import (
    ...
    admin_dashboard, admin_users, edit_user, delete_user, AdminLoginView, UserLoginView, opening_times
)
...
urlpatterns = [
    ...
    path('admin_users/<int:pk>/edit/', edit_user, name='edit_user'),
    path('admin_users/<int:pk>/delete/', delete_user, name='delete_user'),
    ...
    path('opentimes/', opening_times, name='opentimes'),
]